# AgentForge Week 2 Submission Tracker

## Status

Started. Week 2 planning artifacts are in progress.

## Required Deliverables

- [ ] GitHub/GitLab repository with Week 2 changes and setup guide.
...
Local Week 2 source files are stored outside the repo under:

```text
C:\Users\jayce\OneDrive\Gauntlet Ai\Week 2
```
